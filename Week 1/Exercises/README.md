...
The program which the energies is '6plus8plus.py'. The results are shown in the folowing figure.

![alt text](https://github.com/tikrneva/Talent2017-Group6/blob/master/Week%201/Exercises/yrast86.png)

In overall, ratio stays pretty constant, but sudden changes exist aroung magic numbers.
