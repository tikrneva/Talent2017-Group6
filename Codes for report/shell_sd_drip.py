...
plt.ylabel('Two-neutron separation energy [MeV]', fontsize=20)
plt.xlabel('Neutron number', fontsize=20)
plt.title('Two-netron seperation energy for oxygen isotopes', fontsize=20)
plt.savefig('drip'+'.pdf',bbox_inches='tight')
plt.show()
